...
class BayesText:
    def __init__(self, trainingdir, stopwordlist):
        ...
        self.categories = [filename for filename in categories
                           if not os.path.isdir(trainingdir + filename)]
    ...
    def train(self, trainingdir, category):
        ...
        total = 0
        for file in files:
            print("codec file: ", currentdir + '/' + file)
    ...
    def test(self, testdir):
        ...
        categories = [filename for filename in categories 
                      if os.path.isdir(testdir + filename)]
        print("C:", categories)
        correct = 0
        total = 0
...
if __name__ == '__main__':
    b = BayesText("./20news-bydate/train", "./20news-bydate/stopwords0.txt")
    # ret = b.classify("./20news-bydate/test/comp.os.ms-windows.misc/10208")
    # print(ret)
    b.test("./20news-bydate/test/")

# 80.589485%  (7532 test instances)